  ...
  return (
    <BaseLayout footerCenterComponent={<PageViewCounter />}>
      ...
      <article className="prose lg:prose-lg mt-12">
        <h4>Freelancer</h4>
        <p>
          As a freelancer, I am open to new opportunities and projects and would be delighted to
          discuss how I can assist you, whether you are a startup aiming to develop a new product,
          an established business seeking to modernize your systems, or a non-profit organization
          facing a specific technology challenge.
        </p>
        ...
        <p>
          Besides my freelancing, I'm working with two colleagues to build an IT service company (
