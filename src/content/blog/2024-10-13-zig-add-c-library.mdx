---
title: 'zig: use a c library from a dependency'
description: 'Learn how to seamlessly integrate C libraries, specifically focusing on cJSON, into your Zig projects by leveraging zig fetch and modifying your build.zig file.'
